...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.amplitude_slider)
        self.amplitude_label = QtWidgets.QLabel(self.groupBox)
        self.amplitude_label.setObjectName("amplitude_label")
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.amplitude_label)
        ...
        self.formLayout_2.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.radio_keep)
        self.radio_remove = QtWidgets.QRadioButton(self.groupBox)
        self.radio_remove.setObjectName("radio_remove")
        self.formLayout_2.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.radio_remove)
        self.keep_frequenties = QtWidgets.QLineEdit(self.groupBox)
        self.keep_frequenties.setObjectName("keep_frequenties")
        self.formLayout_2.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.keep_frequenties)
        self.remove_frequencies = QtWidgets.QLineEdit(self.groupBox)
        self.remove_frequencies.setObjectName("remove_frequencies")
        self.formLayout_2.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.remove_frequencies)
